(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (magit doom-themes doom-modeline all-the-icons ido-vertical-mode amx ido-completing-read+ smex helm gnuplot ox-latex-subfigure smartparens inf-clojure slime-company exec-path-from-shell slime org org-plus-contrib clj-refactor cider clojure-mode company-lsp elm-mode company powerline gruvbox-theme))))
(custom-set-faces
